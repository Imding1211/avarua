...
class agent_Q:
    ...
    def __init__(self, ISAVE, ITMAX, IMETHOD, ngrd, alpha_ini, alpha_end, alpha_range, beta_ini, beta_end, beta_range):
        ...
        self.env = AI(ISAVE, ITMAX, IMETHOD, ngrd, alpha_ini, alpha_end, alpha_range, beta_ini, beta_end, beta_range)
...
#==============================================================================
    ...
    def update(self, epoch):
        ...
        for episode in range(epoch):
            ...
            print(alpha, round(beta,3), round(error,6))
        ...
        print("Best result")
        print(self.env.best_alpha, round(self.env.best_beta,3), round(self.env.min_error,6))
        
        return alpha_lis, beta_lis, error_lis, self.env.best_alpha, self.env.best_beta, self.env.min_error
