...
!=======================================================================
     ...
     #,imax,imp1,q0,temperature0, ddd
      ...
      !imethod = 11, HMT3_PRIMITIVE
      !imethod = 12, HMT3_CONSERVATIVE
      !imethod = 13, HMT4_PRIMITIVE
      !imethod = 14, HMT4_CONSERVATIVE
      !imethod = 15, HMT5_PRIMITIVE
      !imethod = 16, HMT5_CONSERVATIVE
      !imethod = 17, HMT6_PRIMITIVE
      !imethod = 18, HMT6_CONSERVATIVE          
      !imethod = 19, HMT7_PRIMITIVE
      !imethod = 20, HMT7_CONSERVATIVE 
      !imethod = 21, HMT8_PRIMITIVE
      !imethod = 22, HMT8_CONSERVATIVE 
      !imethod = 23, HMT(2021)_PRIMITIVE
      !imethod = 24, HMT(2021)_CONSERVATIVE
      !imethod = 25, HMT2(2021)_PRIMITIVE
      !imethod = 26, HMT2(2021)_CONSERVATIVE
...
c---------------------MAIN ONE-----------------------SF(k)--------------
      ...
      elseif (imethod .EQ. 11) then
        call HMSTH3_P(Qold1s,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 12) then
        call HMSTH3_C(Qold1s,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 13) then
        call HMSTH4_P(Qold1s,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 14) then
        call HMSTH4_C(Qold1s,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 15) then
        call HMSTH5_P(Qold1s,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 16) then
        call HMSTH5_C(Qold1s,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 17) then
        call HMSTH6_P(Qold1s,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 18) then
        call HMSTH6_C(Qold1s,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 19) then
        call HMSTH7_P(Qold1s,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 20) then
        call HMSTH7_C(Qold1s,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 21) then
        call HMSTH8_P(Qold1s,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 22) then
...
c---------------------MAIN TWO-----------------------SF(k)--------------
      ...
      elseif (imethod .EQ. 11) then
        call HMSTH3_P(Qold1,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 12) then
        call HMSTH3_C(Qold1,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 13) then
        call HMSTH4_P(Qold1,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 14) then
        call HMSTH4_C(Qold1,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 15) then
        call HMSTH5_P(Qold1,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 16) then
        call HMSTH5_C(Qold1,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 17) then
        call HMSTH6_P(Qold1,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 18) then
        call HMSTH6_C(Qold1,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 19) then
        call HMSTH7_P(Qold1,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 20) then
        call HMSTH7_C(Qold1,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 21) then
        call HMSTH8_P(Qold1,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)

      elseif (imethod .EQ. 22) then
        call HMSTH8_C(Qold1,upr,upl,unr,unl,hmsth_alpha,hmsth_bvof)
      ...
      elseif (imethod .EQ. 25) then
        call HMT2_P(Qold1,upr,upl,unr,unl,hmsth_bvof)

      elseif (imethod .EQ. 26) then
        call HMT2_C(Qold1,upr,upl,unr,unl,hmsth_bvof)
      endif
...
c-----------------------------------------------------------------------
      ...
      do k=1,4
        do J=1,imm1
          ...
          upl(j,k)=u1(J,k)+hi*.25*SS*((1.-CK*SS)*DTM+(1.+CK*SS)*DTP)
          
          DTM=DTP
          DTP=u1(JP1+1,k)-u1(JP1,k)
          SS=(2.*DTP*DTM+EPS)/(DTP*DTP+DTM*DTM+EPS)
          upr(j,k)=u1(JP1,k)-hi*.25*SS*((1.-CK*SS)*DTP+(1.+CK*SS)*DTM)
        enddo
      enddo
...
!=======================================================================
! subroutine HMSTH3_PRIMITIVE
!=======================================================================

      SUBROUTINE HMSTH3_P(u0,ur,ul,unr,unl,alpha,bvof)
...
!=======================================================================
! subroutine HMSTH3_CONSERVATIVE
!=======================================================================

      SUBROUTINE HMSTH3_C(u1,ur,ul,unr,unl,alpha,bvof)
...
!=======================================================================
! subroutine HMSTH4_PRIMITIVE
!=======================================================================

      SUBROUTINE HMSTH4_P(u0,ur,ul,unr,unl,alpha,bvof)
...
!=======================================================================
! subroutine HMSTH4_CONSERVATIVE
!=======================================================================

      SUBROUTINE HMSTH4_C(u1,ur,ul,unr,unl,alpha,bvof)
...
!=======================================================================
! subroutine HMSTH5_PRIMITIVE
!=======================================================================

      SUBROUTINE HMSTH5_P(u0,ur,ul,unr,unl,alpha,bvof)
...
!=======================================================================
! subroutine HMSTH5_CONSERVATIVE
!=======================================================================

      SUBROUTINE HMSTH5_C(u1,ur,ul,unr,unl,alpha,bvof)
...
!=======================================================================
! subroutine HMSTH6_PRIMITIVE
!=======================================================================

      SUBROUTINE HMSTH6_P(u0,ur,ul,unr,unl,alpha,bvof)
...
!=======================================================================
! subroutine HMSTH6_CONSERVATIVE
!=======================================================================

      SUBROUTINE HMSTH6_C(u1,ur,ul,unr,unl,alpha,bvof)
...
!=======================================================================
! subroutine HMSTH7_PRIMITIVE
!=======================================================================

      SUBROUTINE HMSTH7_P(u0,ur,ul,unr,unl,alpha,bvof)
...
!=======================================================================
! subroutine HMSTH7_CONSERVATIVE
!=======================================================================

      SUBROUTINE HMSTH7_C(u1,ur,ul,unr,unl,alpha,bvof)
...
!=======================================================================
! subroutine HMSTH8_PRIMITIVE
!=======================================================================

      SUBROUTINE HMSTH8_P(u0,ur,ul,unr,unl,alpha,bvof)
...
!=======================================================================
! subroutine HMSTH8_CONSERVATIVE
!=======================================================================

      SUBROUTINE HMSTH8_C(u1,ur,ul,unr,unl,alpha,bvof)
...
!=======================================================================
! subroutine HMT2_PRIMITIVE
!=======================================================================

      SUBROUTINE HMT2_P(u0,ur,ul,unr,unl,bvof)
...
!=======================================================================
! subroutine HMT2_CONSERVATIVE
!=======================================================================

      SUBROUTINE HMT2_C(u1,ur,ul,unr,unl,bvof)
...
c---------------------right---------------------------------------------
      ...
      do k=1,4
        do i=2,imm1
          ...
          ur(i,k) =  ( 1.- ddp ) * vpr(i,k)  + ddp * vr(i,k)
          ul(i,k) =  ( 1.- ddp ) * vpl(i,k)  + ddp * vl(i,k) 
...
c---------------------left----------------------------------------------
      ...
      do k=1,4
        do i=2,imm1
          ...
          unr(i,k) = ( 1.- ddp ) * vnr(i,k)  + ddp * vrn(i,k)
          unl(i,k) = ( 1.- ddp ) * vnl(i,k)  + ddp * vln(i,k) 
...
!=======================================================================
! subroutine HMSTH3_combine
!=======================================================================

      SUBROUTINE HMSTH3_combine(u1,
     &                         vpr,vpl,vnr,vnl,
     &                         vr,vl,vrn,vln,
     &                         ur,ul,unr,unl,
     &                         alpha)
...
!=======================================================================
! subroutine HMSTH4_combine
!=======================================================================

      SUBROUTINE HMSTH4_combine(u1,
     &                          vpr,vpl,vnr,vnl,
     &                          vr,vl,vrn,vln,
     &                          ur,ul,unr,unl,
     &                          alpha)
...
!=======================================================================
! subroutine HMSTH5_combine
!=======================================================================

      SUBROUTINE HMSTH5_combine(u1,
     &                          vpr,vpl,vnr,vnl,
     &                          vr,vl,vrn,vln,
     &                          ur,ul,unr,unl,
     &                          alpha)
...
c-----------------------------------------------------------------------
     ...
     #,imp1,q0,temperature0, ddd
      ...
      real  u1(0:13000,4) ,xmu(0:13000,4)
...
c-----------------------------------------------------------------------
      ...
      DO  k=1,4
        DO  J=1,imm1
          Jm1=J-1
          DTP= ( u1(Jm1,k) - 2*u1(J,k) + u1(J+1,k) )
          DTM= ( u1(Jm1,k) + 2*u1(J,k) + u1(J+1,k) )
          ddp =  alpha * abs(DTP/DTM) 
          xmu(j,k) = max( (1d0 - ddp), 0. )
        enddo
      enddo
...
c-----------------------------------------------------------------------
      ...
      DO  k=1,4
        DO  J=2,imm1
          ...
          ur(j,k) = vr(j,k)
          ul(j,k) = vr(j,k)+  xmu(j,k) * ds2  + (1-xmu(j,k) ) * ds1
          unr(j,k) = vrn(j,k)
          unl(j,k) = vrn(j,k)+ xmu(j,k) * dd2 + (1-xmu(j,k) ) * dd1
...
!=======================================================================
! subroutine HMSTH6_combine
!=======================================================================

      SUBROUTINE HMSTH6_combine(u1,
     &                          vpr,vpl,vnr,vnl,
     &                          vr,vl,vrn,vln,
     &                          ur,ul,unr,unl,
     &                          alpha)
...
c-----------------------------------------------------------------------
      ...
      DO  k=1,4
        DO  J=2,imm1
          ...
          ur(j,k) = vr(j,k)
          ul(j,k) = vr(j,k)+  xmu(j,3) * ds2  + (1-xmu(j,3) ) * ds1
          unr(j,k) = vrn(j,k)
          unl(j,k) = vrn(j,k)+ xmu(j,3) * dd2 + (1-xmu(j,3) ) * dd1
...
!=======================================================================
! subroutine HMSTH7_combine
!=======================================================================

      SUBROUTINE HMSTH7_combine(u1,
     &                          vpr,vpl,vnr,vnl,
     &                          vr,vl,vrn,vln,
     &                          ur,ul,unr,unl,
     &                          alpha)
...
c-----------------------------------------------------------------------
      ...
      DO  k=1,4
        DO  J=2,imm1
          ...
          if (ds2*ds1 .GT. 0) then

            if (abs(ds2) .LE. abs(ds1)) then
              ul(j,k) = vr(j,k)+ ds2
...
!=======================================================================
! subroutine HMSTH8_combine
!=======================================================================

      SUBROUTINE HMSTH8_combine(u1,
     &                          vpr,vpl,vnr,vnl,
     &                          vr,vl,vrn,vln,
     &                          ur,ul,unr,unl,
     &                          alpha)
...
!=======================================================================
! subroutine HMT2_combine
!=======================================================================

      SUBROUTINE HMT2_combine(u1,
     &                        vpr,vpl,vnr,vnl,
     &                        vr,vl,vrn,vln,
     &                        ur,ul,unr,unl)
...
c---------------------right---------------------------------------------
      ...
      do k=1,4
        do i=2,imm1
          ...
          if ((u1(i+1,k)-u1(i,k))*(u1(i,k)-u1(i-1,k)).GT.0) then
            ur(i,k) = zeta * vpr(i,k) + ( 1.- zeta ) * vr(i,k)
            ul(i,k) = zeta * vpl(i,k) + ( 1.- zeta ) * vl(i,k)
          else
            ur(i,k) = vpr(i,k)
            ul(i,k) = vpl(i,k)
          endif
...
c---------------------left----------------------------------------------
      ...
      do k=1,4
        do i=2,imm1
          ...
          if ((u1(i+1,k)-u1(i,k))*(u1(i,k)-u1(i-1,k)).GT.0) then
            unr(i,k) = zeta * vnr(i,k) + ( 1.- zeta ) * vrn(i,k)
            unl(i,k) = zeta * vnl(i,k) + ( 1.- zeta ) * vln(i,k)
          else
            unr(i,k) = vnr(i,k)
            unl(i,k) = vnl(i,k)
          endif
